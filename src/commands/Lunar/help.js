...
> This bot spawns animals of different colours whenever someone sends a message.
> You claim the animal by reacting to the message.
> The first person to react, gets the animal plus 5 currency. Everyone else gets 1 currency.
